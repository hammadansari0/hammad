...
export default function Education() {
  ...
  return (
    <section className={`relative bg-[url('/src/assets/educationexperience.svg')] bg-no-repeat bg-cover bg-center w-full min-h-screen px-4 sm:px-8 md:px-16 py-16 ${sectionBg}`} id="education">
      <motion.h2
