...
export default function Education() {
  return (
    <section className="w-full min-h-screen px-4 sm:px-8 md:px-16 py-16 text-black bg-white" id="education">
      <motion.h2
              ...
              >
                ...
                >
                  <div className="bg-white p-6 rounded-xl shadow-md transform transition duration-300 hover:shadow-xl hover:-translate-y-1 mx-auto max-w-xl">
                    ...
                    <h4 className="text-indigo-600 font-bold text-md mb-2">{edu.degree}</h4>
                    <div className="text-sm bg-gray-100 inline-block px-3 py-1 rounded-full text-gray-600 mb-2">
                      {edu.duration}
                    </div>
