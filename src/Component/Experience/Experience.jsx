...
export default function Experience() {
  ...
  return (
    <section id="experience" className={`relative bg-[url('/src/assets/educationexperience.svg')] bg-no-repeat bg-cover bg-center w-full min-h-screen px-4 sm:px-8 md:px-16 py-16 ${sectionBg}`}>
      <motion.h2
