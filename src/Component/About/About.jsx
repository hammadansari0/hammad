...
export default function About() {
    return (
        // <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-white text-gray-800" id="about">
        <section
            className="min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-white text-gray-800"
            id="about"
        >
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="w-16 sm:w-24 h-1 mx-auto bg-purple-500 mb-6" />
                ...
                <motion.p
                    className="text-base sm:text-lg text-gray-600 mb-3 text-center sm:text-justify"
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                ...
                <motion.p
                    className="text-base sm:text-lg text-gray-600 mb-8 text-center sm:text-justify"
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                        {technicalSkills.map((skill, index) => (
                            <span
                                key={index}
                                className="px-4 py-2 bg-gray-100 text-sm font-medium rounded-full shadow-sm hover:bg-purple-100 transition"
                            >
                                {skill}
                            </span>
                        ))}
